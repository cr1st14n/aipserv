...
<head>
    ...
    <link href="{{ asset('resources/template/lib/highlightjs/github.css') }}" rel="stylesheet">
...
<body>
    ...
    <div class="br-sideleft overflow-y-auto">
        ...
        <div class="br-sideleft-menu">
            <a href="#" class="br-menu-link" onclick="register_1()">
                <div class="br-menu-item">
                    <i class="menu-item-icon icon ion-ios-home-outline tx-22"></i>
                    <span class="menu-item-label">Registro</span>
                </div><!-- menu-item -->
            </a><!-- br-menu-link -->
            <a href="#" class="br-menu-link" onclick="list_contenido_1()">
                <div class="br-menu-item">
                    <i class="menu-item-icon icon ion-ios-home-outline tx-22"></i>
                    <span class="menu-item-label">Contenido</span>
                </div><!-- menu-item -->
            </a><!-- br-menu-link -->
        </div><!-- br-sideleft-menu -->
    </div><!-- br-sideleft -->
                            ...
                            <a href="" class="media-list-link read">
                                <div class="media pd-x-20 pd-y-15">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="tx-12 mg-b-0">My entire soul, like these sweet mornings of spring.
                                        </p>
                                    </div>
                                </div><!-- media -->
                            </a>
                        ...
                        <div class="media-list">
                                ...
                                <div class="media pd-x-20 pd-y-15">
                                    ...
                                    <div class="media-body">
                                        <p class="tx-13 mg-b-0 tx-gray-700"><strong
                                                class="tx-medium tx-gray-800">Suzzeth Bungaos</strong> tagged you and
                                            18 others in a post.</p>
                            ...
                            <a href="" class="media-list-link read">
                                <div class="media pd-x-20 pd-y-15">
                                    ...
                                    <div class="media-body">
                                        <p class="tx-13 mg-b-0 tx-gray-700"><strong
                                                class="tx-medium tx-gray-800">Julius Erving</strong> wants to connect
                                            with you on your conversation with <strong
    ...
    <!-- ########## START: MAIN PANEL ########## -->
    <div class="br-mainpanel" id="br-mainpanel">
        <div class="br-pageheader pd-y-15 pd-l-20">
            <nav class="breadcrumb pd-0 mg-0 tx-12">
                <a class="breadcrumb-item active">Contenido</a>
            </nav>
        </div><!-- br-pageheader -->
