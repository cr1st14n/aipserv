...
<body>
        ...
        <div class="br-sideleft-menu">
            <a onclick="view_home_user()" href="#" class="br-menu-link">
                <div class="br-menu-item">
                    ...
                    <span class="menu-item-label">Gestion de Usuarios</span>
                </div>
                <!-- menu-item -->
            </a><!-- br-menu-link -->
        </div>
                                ...
                                <div class="media pd-x-20 pd-y-15">
                                    ...
                                    <div class="media-body">
                                        <p class="tx-13 mg-b-0 tx-gray-700">
                                            <strong class="tx-medium tx-gray-800">Suzzeth Bungaos</strong>
                                ...
                                <div class="media pd-x-20 pd-y-15">
                                    ...
                                    <div class="media-body">
                                        <p class="tx-13 mg-b-0 tx-gray-700">
                                            ...
                                            <strong class="tx-medium tx-gray-800">The Social Network</strong>
                                        </p>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-header wd-200">
                        <ul class="list-unstyled user-profile-nav">
                            <li>
                                <a href=""><i class="icon ion-ios-person"></i> Edit Profile</a>
                            </li>
                            <li>
                                <a href=""><i class="icon ion-ios-gear"></i> Settings</a>
                            </li>
                            <li>
                                <a href=""><i class="icon ion-ios-download"></i> Downloads</a>
                            </li>
                            <li>
                                <a href=""><i class="icon ion-ios-star"></i> Favorites</a>
                            </li>
                            <li>
                                <a href=""><i class="icon ion-ios-folder"></i> Collections</a>
                            </li>
                            <li>
    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody" id="IndexView">
